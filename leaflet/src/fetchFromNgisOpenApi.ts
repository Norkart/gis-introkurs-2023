...
export const fetchFromNgisOpenApi = (bounds: string) => {
  const url = `https://openapi-test.kartverket.no/v1/datasets/63cb2b40-1461-4a9a-90c1-446ef0ee42f4/features?bbox=${bounds}&crs_EPSG=4326&normalized_for_visualization=true&query=eq(*,Bygning)`;
  return fetchWithBasicAuth(url, user, pass, {
